...
//
// ВНИМАНИЕ: ни исходного markdown, ни собранного JSON в публичном
// репозитории нет — это сам словарь, а не код. Оба файла лежат рядом с
// репозиторием; чтобы запустить скрипт, положите project-context/alias-categories
// с alias-catalog.md и alias-levels.md на место.
//
