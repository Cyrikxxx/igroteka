...
286 юнит-тестов плюс 16 smoke-сценариев на настоящих сокет-соединениях: они
...
│   │   │   │   ├── join/             общий вход по коду для обеих игр
...
│       ├── scripts/                  16 smoke-сценариев + наполнители комнат
...
- **286 тестов в 32 файлах** — серверная логика в node, хуки и экраны в jsdom
- **16 smoke-сценариев** на настоящих сокет-соединениях
- **Наполнители комнат** — посмотреть на партию в 16 и 36 человек, не собирая
  столько телефонов
