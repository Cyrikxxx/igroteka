    ...
    <PageShell active="О нас">
      ...
      <div className="pl-intro">
        <InkCard style={{ gap: 14 }}>
          ...
          <p className="pl-text">
            Алиас и Мафия живут в коробках: карточки со словами, роли на бумажках,
            песочные часы. Коробка обычно остаётся дома, а сыграть хочется в гостях,
            в поезде или на даче.
          </p>
          <p className="pl-text">
            Игротека — те же игры, только в телефоне. Открыл ссылку, ввёл имя,
            играешь: ни установки, ни регистрации. В Мафии сайт заодно работает за
            ведущего: раздаёт роли и сам ведёт ночь, поэтому за столом не остаётся
            человека, который весь вечер только объявляет, кому просыпаться.
          </p>
        </InkCard>
