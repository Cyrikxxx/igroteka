...
// Общий экран финального счёта — работает и для LOCAL, и для ONLINE
// (определяется по полю Game.mode). См. DESIGN.md §5.8.
      ...
      <main className="flex-1 mx-auto w-full max-w-2xl px-4 md:px-8 py-10 md:py-16 text-center">
        ...
        <div className="mt-10 flex flex-col md:flex-row gap-3 md:justify-center">
          ...
          {game.mode === "LOCAL" ? (
            ...
            <Button size="lg" onClick={() => router.push("/room/new")}>
              Новая комната
            </Button>
          )}
        </div>
